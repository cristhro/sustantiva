export const CreditTalentCenterABI = [
  ...
  {
    inputs: [{ internalType: 'bytes32', name: 'dataHash_', type: 'bytes32' }],
    name: 'applyToCredit',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    name: 'fixedRateIrms',
    outputs: [
      { internalType: 'contract FixedRateIrm', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'newBorrowRate_', type: 'uint256' },
    ],
